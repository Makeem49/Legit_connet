...
from app_folder.blueprints.users.model import User, Role, Follow
...
def make_shell_context():
    return dict(app=app, User=User, Follow=Follow, db=db, Role=Role, Post=Post, Keyword=Keyword, post_keywords=post_keywords, Permission=Permission)
